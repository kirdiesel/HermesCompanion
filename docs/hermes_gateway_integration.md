...
Changing the installed Hermes gateway is an external mutation and requires approval plus its own tests. This repository currently provides only the verified boundary contract.
